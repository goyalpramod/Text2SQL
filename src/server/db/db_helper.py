...
class sqlite_database(Database):
    def __init__(self):
        self.db_path = 'temp.db'  # Replace with the path to your SQLite database file
    ...
    # async def create_database_and_schema(self, db_name):
    #     try:
    #         db_url = os.getenv('SQLITE_DB_URL')  # Get the database URL from the environment variable
